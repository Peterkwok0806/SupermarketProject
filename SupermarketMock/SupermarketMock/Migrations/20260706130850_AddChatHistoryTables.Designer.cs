...
namespace SupermarketMock.Migrations
{
    ...
    [Migration("20260706130850_AddChatHistoryTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupermarketMock.Models.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SupermarketMock.Models.ChatSession", b =>
                {
                    b.Property<string>("SessionId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("IsDeleted", "LastActivityAt")
            ...
            modelBuilder.Entity("SupermarketMock.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 6, 13, 8, 49, 429, DateTimeKind.Utc).AddTicks(8933),
                            Email = "admin@supermart.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$2cKB5/Cj4qX0WGTbqmPdMuws4oi26Av/f/y6szoWjddqi0MSOtSxi",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("SupermarketMock.Models.ChatMessage", b =>
                {
                    b.HasOne("SupermarketMock.Models.ChatSession", "Session")
                        .WithMany("Messages")
